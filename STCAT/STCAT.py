...
##############################################################################################################################################################################################################
    ...
    return adata_T_sub_CD8
################################################################################################################################################################## 
        
    logger.info("▶ Running CD4 directly...")
    adata_T_sub_CD4 = process_CD4()
    logger.info("✅ CD4 returned")

    logger.info("▶ Running CD8 directly...")
    adata_T_sub_CD8 = process_CD8()
    logger.info("✅ CD8 returned")
